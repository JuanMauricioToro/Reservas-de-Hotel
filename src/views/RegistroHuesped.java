...
public class RegistroHuesped extends JFrame {
	...
	int xMouse, yMouse;
	private ControladorHuesped controllerHuesped;
	...
	public RegistroHuesped() {
		...
		JLabel lblNumeroReserva = new JLabel("NÚMERO DE DOCUMENTO");
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(txtNombre.getText() != null && txtApellido.getText() != null && txtNreserva.getText() != null
						&& txtFechaN.getDate() != null && txtTelefono.getText() != null) {
	...
	public void guardar() {
		...
		Date fechaNaci;
		this.controllerHuesped = new ControladorHuesped();
		
		try {
			
			fechaNaci = sdf.parse(((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText());
			
			Huesped huesped = new Huesped(txtNreserva.getText(),txtNombre.getText(),txtApellido.getText(), fechaNaci,txtNacionalidad.getSelectedItem().toString(),
			...
			System.out.println(huesped.toString()+" idReserva: "+getIdReserva());
			limpiarPantalla();
			ReservasView m = new ReservasView();
			m.setVisible(true);
			dispose();
